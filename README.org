...
[[https://github.com/0x46b/Polyhymnia/actions/workflows/polyhymnia_ci_build.yml/badge.svg]] [[https://github.com/0x46b/Polyhymnia/actions/workflows/encoder_ci_tests.yml/badge.svg]] [[https://github.com/0x46b/Polyhymnia/actions/workflows/polyhymnia_ci_tests.yml/badge.svg]]
...
** WIP Software [0/3]
  ...
  - Features [0/4]
    - [ ] Add code for LFO
    - [X] Saving/Loading settings to/from SD-card
    - [X] Saving/Loading patches to/from SD-card
    - [ ] Add effects (Reverb, Delay, BitCrush, ...)
** WIP Hardware [1/3]
  - [X] Build MIDI-port
  - [X] Display control
    - [X] Find working pinout/connection 
...
- [X] 3 detunable VCOs with selectable waveforms (Saw, Triangle, Sine, Square)
- [X] controllable ladder-Lopass-filter
- [ ] controllable LFO for automating filter
- [X] controllable ADSR-Envelope
...
- [[https://github.com/vindar/ILI9341_T4][ILI9341_T4 Library]]
...
- [[https://www.pjrc.com/teensy/teensyduino.html][Teensyduino]]
- [[https://www.envox.eu/studio/studio-introduction/][EEZ Studio]]
...
** Audio-Amplifier (everything x2 if you want stereo):
- [X] LM386 Audio-Amplifier IC 
- [X] ElKo 250&micro;F
- [X] CerKo 33nF [333]
- [X] CerKo 50nF (alternative 47nF [473]
- [X] Resistor 10k&Omega;
- [X] Resistor 10&Omega;
- [X] Potentiometer 10k&Omega;
...
[[./Schematics/img/Encoder_Control.png][Control Unit Schematics]]
[[./Schematics/img/Encoder_Control.png]]
...
[[./Schematics/img/audio_amp.png][LM386 Audio Amp Schematics (Mono)]]
[[./Schematics/img/audio_amp.png]]

* Enclosure
[[./Enclosure/imgs/3d.png][3D rendering]]
[[./Enclosure/imgs/3d.png]]

[[./Enclosure/imgs/Explosion.png][Explosion View]]
[[./Enclosure/imgs/Explosion.png]]

[[./Enclosure/imgs/right.png][Right Side View]]
[[./Enclosure/imgs/right.png]]

[[./Enclosure/imgs/front.png][Front View]]
[[./Enclosure/imgs/front.png]]
