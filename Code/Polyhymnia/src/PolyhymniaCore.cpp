...
PolyhymniaCore::PolyhymniaCore(AudioSynthWaveform *vco1,
    ...
    : _polyVCO1(vco1, 70, 76, 0.25, factory.CreateDefaultForContext("DCO 1")),
      _polyVCO2(vco2, 77, 78, 0.25, factory.CreateDefaultForContext("DCO 2")),
      _polyVCO3(vco3, 85, 86, 0.25, factory.CreateDefaultForContext("DCO 3")),
