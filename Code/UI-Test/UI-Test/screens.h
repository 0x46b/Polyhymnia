...
typedef struct _objects_t {
    ...
    lv_obj_t *obj1;
    lv_obj_t *dco_1;
    lv_obj_t *dco_1__dco_number;
    lv_obj_t *dco_1__waveform_triangle;
    lv_obj_t *dco_1__waveform_saw;
    lv_obj_t *dco_1__waveform_square;
    lv_obj_t *dco_1__waveform_sine;
    lv_obj_t *dco_1__detune;
    lv_obj_t *dco_1__volume;
    lv_obj_t *dco_1__obj0;
    lv_obj_t *dco_2;
    lv_obj_t *dco_2__dco_number;
    lv_obj_t *dco_2__waveform_triangle;
    lv_obj_t *dco_2__waveform_saw;
    lv_obj_t *dco_2__waveform_square;
    lv_obj_t *dco_2__waveform_sine;
    lv_obj_t *dco_2__detune;
    lv_obj_t *dco_2__volume;
    lv_obj_t *dco_2__obj0;
    lv_obj_t *dco_3;
    lv_obj_t *dco_3__dco_number;
    lv_obj_t *dco_3__waveform_triangle;
    lv_obj_t *dco_3__waveform_saw;
    lv_obj_t *dco_3__waveform_square;
    lv_obj_t *dco_3__waveform_sine;
    lv_obj_t *dco_3__detune;
    lv_obj_t *dco_3__volume;
    lv_obj_t *dco_3__obj0;
    lv_obj_t *envelope;
    lv_obj_t *envelope__attack;
    lv_obj_t *envelope__release;
    lv_obj_t *envelope__decay;
    lv_obj_t *envelope__sustain;
