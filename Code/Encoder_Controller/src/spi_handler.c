...
static volatile spi_state _spi_state = CMD_EXEC;
static volatile RingBuffer _transferBuffer;
static volatile SPI_Frame _lastCommand;
static volatile spi_command_response_length_in_bytes _transfer_length_in_bytes = None;
static volatile uint8_t _transferred_number_of_bytes = 0;
