...
void envelope_initialize(envelope_controller *controller, uint8_t channelAttack, uint8_t channelDecay, uint8_t channelSustain, uint8_t channelRelease){
...
void filter_initialize(filter_controller *controller, uint8_t cutoffChannel, uint8_t resonanceChannel){
	controller->config_cutoff.channel = cutoffChannel;
	controller->config_cutoff.factor = 1;
	
	controller->config_resonance.channel = resonanceChannel;
